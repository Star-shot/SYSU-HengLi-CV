...
%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{itemize}
        \item \textbf{Kun Xiang*}, \textbf{Heng Li*}, Terry Jingchen Zhang, Yinya Huang, Zirong Liu, Peixin Qu, Jixi He, Jiaqi Chen, Yu-Jie Yuan, Jianhua Han, Hang Xu, Hanhui Li, Mrinmaya Sachan, Xiaodan Liang \hfill \textbf{NeurIPS 2025}（CCF-A类会议）
    ...
    \begin{itemize}
        \item \textbf{主要工作}：利用强化学习优化大语言模型在物理竞赛题场景下的推理与求解能力。
    \end{itemize}
    
    \vspace{0.5em}
    {\large \textbf{大创项目：自动化医疗体检机器学习平台}}
    \begin{itemize}
        \item \textbf{职责}：负责全流程架构设计与可视化页面搭建。
    \end{itemize}
